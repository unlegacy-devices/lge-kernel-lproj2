...
#if defined (CONFIG_BACKLIGHT_BU61800) || defined(CONFIG_BACKLIGHT_RT9396)
...
void __init msm7x27a_v1_init_i2c_backlight(int bus_num)
{
...
#endif
#if defined (CONFIG_BACKLIGHT_BU61800) || defined(CONFIG_BACKLIGHT_RT9396)
	lge_add_gpio_i2c_device(msm7x27a_v1_init_i2c_backlight);
#endif
#if defined(CONFIG_BACKLIGHT_LGE_RT8966)
