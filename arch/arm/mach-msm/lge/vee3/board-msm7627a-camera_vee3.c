...
#ifdef CONFIG_HI351
static uint32_t hi351_cam_off_gpio_table[] = {
	GPIO_CFG(15, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(42, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static uint32_t hi351_cam_on_gpio_table[] = {
	GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(42, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
};

static struct gpio hi351_cam_req_gpio[] = {
};

static struct msm_gpio_set_tbl hi351_cam_gpio_set_tbl[] = {
};

static struct msm_camera_gpio_conf gpio_conf_hi351 = {
	.camera_off_table = hi351_cam_off_gpio_table,
	.camera_off_table_size = ARRAY_SIZE(hi351_cam_off_gpio_table),
	.camera_on_table = hi351_cam_on_gpio_table,
	.camera_on_table_size = ARRAY_SIZE(hi351_cam_on_gpio_table),
	.cam_gpio_req_tbl = hi351_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(hi351_cam_req_gpio),
	.cam_gpio_set_tbl = hi351_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(hi351_cam_gpio_set_tbl),
	.gpio_no_mux = 1,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_hi351 = {
	.mount_angle	= 90,
	.cam_vreg = msm_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_hi351,
};
