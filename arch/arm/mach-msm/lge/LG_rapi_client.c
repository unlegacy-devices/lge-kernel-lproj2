/* 
 * arch/arm/mach-msm/lge/factory/LG_rapi_client.c
 *
...
#include <mach/lge/lg_diag_unifiedmsgtool.h>
#include <linux/slab.h>
#include <mach/lge/lge_diag_eri.h>
#include <mach/lge/LG_rapi_client.h>
